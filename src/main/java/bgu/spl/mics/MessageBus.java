...
public interface MessageBus {
     ...
     * @pre: list of subscribers to 'type' doesn't contain m
     * @post: list of subscribers to 'type' contains m
     */
     ...
     * @pre: event is not completed yet
     ...
     * @pre: None
     * @Post: b will be in the message queues of all micro-services subscribed to the broadcast type
     */
     ...
     * @pre: None
     * @post: whoever was first to get this message got it
     */
     ...
     * @pre: None
     * @post: m's message-queue removed and m removed from all relevant hash-maps
     */
     ...
     *                              to became available.
     * @pre: m is registered
     * @post: first message is no longer in m's messages queue
     */
